...
## Berechnung der Kurvenanteile

Es gibt ein Merkmal $X$, dessen Werte normal verteilt sind ($N(\mu , \sigma)$) mit $\mu = 10$
und $\sigma = 3,5$. Berechnen Sie die Wahrscheinlichkeit für:
$$
P\left ( \frac{X - 10}{3,5} < 0 \right )
$$
