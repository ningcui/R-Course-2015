...
$$
  \rho = 1 - \frac{6\cdot \sum^N_{i=1} d_j^2}{N(N^2 - 1)}
$$
...
#nicht genug Daten für Funktion
#Beschreibung der numerischen Korrelation gelingt nicht -->Wechsel zum ordinalen Niveau
```

## Correlation
```{r cor}
cor(fast.food.data$SalesRank, fast.food.data$LocationRank)
#hoher Korrelationswert -->Daten scheinen stark zusammenzuhängen
```
