...
```{r}
A
A * 2 #Skalarmultiplikation

D <- matrix(6:11, nrow = 3, ncol = 2, byrow = T)
A; D

A %*% D #Matrixmultiplikation
```
...
- entwerfen Sie drei lineare Modelle mit Ihrer Parameterschätzung;#zweite Matrix
